...
const testimonials = [
  {
    quote:
      "RSK Associates cut our support ticket volume by 70%. Our team now focuses on complex issues while AI handles the rest.",
    author: "Sarah Chen",
  ...
  {
    quote: "Finally, 24/7 support without the 24/7 staffing costs. RSK Associates pays for itself within the first month.",
    ...
    <section className="relative py-16 sm:py-24 lg:py-32 border-t border-border">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Join thousands of teams already using RSK Associates</p>
        </motion.div>
